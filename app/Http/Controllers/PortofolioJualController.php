...
class PortofolioJualController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $portobeli = PortofolioBeli::where('user_id', '1')->with('emiten')->get()->toArray();
        $portojual = PortofolioJual::where('user_id', '1')->with('emiten')->get()->toArray();
